...
#        self.fc3 = Linear(args.embed_dim*2, args.embed_dim)
    ...
    def image_encoder(self,src_img_features):
    ...
    def forward(self, x, src_img_features, encoder_padding_mask, batch_len, lay_idx, attn_mask: Optional[Tensor] = None):
        ...
        if lay_idx >= 0:
            ...
            src_img_features_relate = self.gating(x[:batch_len], multimodal_semantic_att)

            # x = x + src_img_features_relate
...
class GatingMechanism(nn.Module):
    def __init__(self, args):
        ...
        # self.fc_img2 = Linear(args.gating_dim * 2, 1)
